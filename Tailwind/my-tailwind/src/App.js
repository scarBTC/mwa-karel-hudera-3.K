...
function App() {
  return (
    <div className="w-3/4 my-0 mx-auto">
      <Header />
      <h1 className="text-center pt-10">XXXXXXX XXXXXXXXX</h1>
      <p className="text-center m-auto pt-5 w-60">xxxxx xxxx x x x x xxxxx x x xx  xxxx xxxxxxx xxx xx xxx x xxxxxxxx xxxxxx xxxx  xxx xxx</p>
